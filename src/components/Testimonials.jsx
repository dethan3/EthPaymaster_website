  ...
  return (
    <>
      {testimonials.map((testimonial, id) => (
        <figure
          key={id}
          className="flex flex-col gap-6 py-8 glassy-screen px-mobileBound flex-nowrap sm:px-7 sm:py-8 sm:gap-7 md:px-8 md:py-9 md:gap-8 lg:px-9 lg:py-10 lg:gap-9"
        >
          <QuoteIcon />
