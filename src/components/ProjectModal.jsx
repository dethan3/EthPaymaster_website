      ...
      >
        <div className="w-[100%] p-9 flex flex-col flex-nowrap gap-9">
          <button
            ...
            className="self-end shrink-0 glassy-icon w-iconButtonMobile sm:w-iconButtonSmall md:w-iconButtonMedium lg:w-iconButtonLarge h-iconButtonMobile sm:h-iconButtonSmall md:h-iconButtonMedium lg:h-iconButtonLarge"
            aria-label="Close modal window"
            onClick={toggleDialog}
          >
            <CloseIcon />
          </button>
          <h4 className="ml-auto mr-auto font-extrabold text-center">
            {projectData.title}
          </h4>
          <img
          ...
          {projectData.details.description !== null && (
            <>
              <h5 className="ml-auto mr-auto text-center">About</h5>
              <p className="ml-auto mr-auto text-justify">
                {projectData.details.description}
              </p>
            </>
          )}
          <h5 className="ml-auto mr-auto text-center">Technologies</h5>
          ...
          <div className="flex flex-row flex-wrap items-center justify-center gap-7">
            {projectData.details.url !== null && (
              <a
                ...
                className="px-6 glassy-icon shrink-0"
              >
                Visit Website
              </a>
            )}
