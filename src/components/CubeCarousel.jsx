...
export default function CubeCarousel({ name, carouselImages }) {
  ...
  return (
    <div className="flex flex-col items-center gap-5 flex-nowrap sm:gap-6 md:gap-7">
      ...
      <fieldset className="flex flex-col items-center justify-center gap-5 flex-nowrap">
        <ol className="mb-4">
          {carouselImages.map((image, id) => (
            <li
              key={id}
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-7 sm:gap-8">
          {carouselImages.map((image, id) => (
            <input
              key={id}
