...
export default function Navbar({ isDarkMode, toggleDarkMode }) {
  ...
  const NavMenu = () => {
    return (
      <>
        <ul className="flex flex-row items-center justify-between flex-nowrap sm:order-1">
          <li>
            <button
              id="dark-light-mode"
        ...
        <nav>
          <ul className="flex flex-col items-center flex-nowrap gap-7 my-7 sm:flex-row sm:gap-6 md:gap-9 lg:gap-11">
        ...
        <div className="flex flex-col flex-nowrap justify-center items-center sm:fixed sm:left-[8px] sm:bottom-[14px] sm:w-[50px] ">
          ...
          <button
            className="hidden glassy-icon w-iconButtonMobile sm:w-iconButtonSmall md:w-iconButtonMedium lg:w-iconButtonLarge h-iconButtonMobile sm:h-iconButtonSmall md:h-iconButtonMedium lg:h-iconButtonLarge sm:flex"
            aria-label={
              isSocialOpen
  ...
  return (
    <>
      <button
        id="open-mobile-menu"
        className="ml-auto glassy-icon w-iconButtonMobile sm:w-iconButtonSmall md:w-iconButtonMedium lg:w-iconButtonLarge h-iconButtonMobile sm:h-iconButtonSmall md:h-iconButtonMedium lg:h-iconButtonLarge sm:hidden"
